      ...
      render(){
        ...
        return(
            ...
            {canciones.map((cancion) => {
                return (
            <><img src={canciones.albums.cover} alt="" class="fotoback track" /><a href="./detail-artist.html" class="nombretema"><br /> {cancion.title}</a><br /><a href="./detail-album.html" class="albumde"><br /> {cancion.album}</a><br /><iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/2iEGj7kAwH7HAa5epwYwLB?utm_source=generator&theme=0" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe><br /><br /></>
             );
          })}
